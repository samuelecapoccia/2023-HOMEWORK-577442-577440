...
public class TestBuilderGithub {
	...
	public void testMonolocaleConAttrezzoSingoloDuplicato() {
		...
		assertTrue(size==1);
		assertEquals(new Attrezzo("spada",1),monolocale.getStanzaCorrente().getAttrezzi().get("spada"));
	}
	...
	public void testAggiuntaAttrezziAStanze_AppenaAggiunte() {
		...
		labirintoBuilder
				...
				.addAttrezzo(nomeAttrezzo, peso)
				.getLabirinto();
		assertTrue(this.labirintoBuilder.getMappaStanze().get(nomeStanza).getAttrezzi().containsKey(nomeAttrezzo));
	...
	public void testAggiuntaAttrezzoAStanze_AppenaAggiunteMultiple() {
		...
		this.labirintoBuilder
				...
				.getLabirinto();
		Attrezzo attrezzo = new Attrezzo(nomeAttrezzo,peso);
		Map<String,Attrezzo> attrezzi = labirintoBuilder.getMappaStanze().get(nomeStanza).getAttrezzi();
	...
	public void testLabirintoCompletoConTutteLeStanze() {
		...
		Map<String,Attrezzo> mappa = new HashMap<>();
		mappa.put("chiave", a1);
		mappa.put("lanterna", a2);
